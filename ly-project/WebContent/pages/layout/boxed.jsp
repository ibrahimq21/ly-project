    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="top-nav.jsp"><i class="fa fa-circle-o"></i> Top Navigation</a></li>
            <li class="active"><a href="boxed.jsp"><i class="fa fa-circle-o"></i> Boxed</a></li>
            <li><a href="fixed.jsp"><i class="fa fa-circle-o"></i> Fixed</a></li>
            <li><a href="collapsed-sidebar.jsp"><i class="fa fa-circle-o"></i> Collapsed Sidebar</a></li>
          </ul>
        </li>
        <li>
          <a href="../widgets.jsp">
