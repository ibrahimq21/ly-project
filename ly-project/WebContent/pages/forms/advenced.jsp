      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="advanced.jsp"><i class="fa fa-circle-o"></i> Advanced Elements</a></li>
            <li><a href="editors.jsp"><i class="fa fa-circle-o"></i> Editors</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
...
<script>
  $(function () {
    ...
    $('#daterange-btn').daterangepicker(
      ...
      function (start, end) {
        $('#daterange-btn span').jsp(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'))
      }
    )
